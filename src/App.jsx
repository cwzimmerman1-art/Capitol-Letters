...
const WORD_BANK = {
  ...
  "2026-06-09": { word: "NUDES", fact: "As in, the bike riders at the World Naked Bike Ride. It returns to Madison later this month, 11am on June 20. Up to 200 riders are expected to get in on this year's...fleshy fun. Sorry to make you read that."}
